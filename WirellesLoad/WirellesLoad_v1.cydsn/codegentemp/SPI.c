...
static void SPI_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void SPI_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[SPI_RX_SCL_MOSI_PIN_INDEX] = SPI_HSIOM_I2C_SEL;
            hsiomSel[SPI_TX_SDA_MISO_PIN_INDEX] = SPI_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[SPI_RX_SCL_MOSI_PIN_INDEX] = SPI_HSIOM_SPI_SEL;
            hsiomSel[SPI_TX_SDA_MISO_PIN_INDEX] = SPI_HSIOM_SPI_SEL;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[SPI_TX_SDA_MISO_PIN_INDEX] = SPI_HSIOM_UART_SEL;
                pinsDm  [SPI_TX_SDA_MISO_PIN_INDEX] = SPI_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[SPI_RX_SCL_MOSI_PIN_INDEX] = SPI_HSIOM_UART_SEL;
                    pinsDm  [SPI_RX_SCL_MOSI_PIN_INDEX] = SPI_PIN_DM_DIG_HIZ;
                }
                ...
                if (SPI_UART_MODE_STD == subMode)
                {
                    if (0u != (SPI_UART_CTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[SPI_SCLK_PIN_INDEX] = SPI_HSIOM_UART_SEL;
                        pinsDm  [SPI_SCLK_PIN_INDEX] = SPI_PIN_DM_DIG_HIZ;
                    }
                    ...
                    if (0u != (SPI_UART_RTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[SPI_SS0_PIN_INDEX] = SPI_HSIOM_UART_SEL;
                        pinsDm  [SPI_SS0_PIN_INDEX] = SPI_PIN_DM_STRONG;
