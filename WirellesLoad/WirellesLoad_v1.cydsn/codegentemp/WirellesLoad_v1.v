...
module SCB_P4_v3_0_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("d9f30e45-97b2-47ac-8ca1-5275a349f9d8/5382e105-1382-4a2e-b9f4-3bb2feba71e0"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d9f30e45-97b2-47ac-8ca1-5275a349f9d8/22863ebe-a37b-476f-b252-6e49a8c00b12"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module SCB_P4_v3_0_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("872a5ad9-40e4-400a-91d7-a285b754aee3/38438ec5-732c-47a6-9805-e2b697fb82a2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("872a5ad9-40e4-400a-91d7-a285b754aee3/1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("872a5ad9-40e4-400a-91d7-a285b754aee3/ed092b9b-d398-4703-be89-cebf998501f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__NRF_SS_net;
	wire [0:0] tmpFB_0__NRF_SS_net;
	wire [0:0] tmpIO_0__NRF_SS_net;
	wire [0:0] tmpINTERRUPT_0__NRF_SS_net;
	electrical [0:0] tmpSIOVREF__NRF_SS_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		NRF_SS
		 (.oe(tmpOE__NRF_SS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NRF_SS_net[0:0]}),
		  .io({tmpIO_0__NRF_SS_net[0:0]}),
		  .siovref(tmpSIOVREF__NRF_SS_net),
		  .interrupt({tmpINTERRUPT_0__NRF_SS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NRF_SS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__NRF_CSN_net;
	wire [0:0] tmpFB_0__NRF_CSN_net;
	wire [0:0] tmpIO_0__NRF_CSN_net;
	wire [0:0] tmpINTERRUPT_0__NRF_CSN_net;
	electrical [0:0] tmpSIOVREF__NRF_CSN_net;

	cy_psoc3_pins_v1_10
		#(.id("22dd2ff9-7e31-494a-be22-00628981da60"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		NRF_CSN
		 (.oe(tmpOE__NRF_CSN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NRF_CSN_net[0:0]}),
		  .io({tmpIO_0__NRF_CSN_net[0:0]}),
		  .siovref(tmpSIOVREF__NRF_CSN_net),
		  .interrupt({tmpINTERRUPT_0__NRF_CSN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NRF_CSN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OPT_IRQ_net;
	wire [0:0] tmpIO_0__OPT_IRQ_net;
	wire [0:0] tmpINTERRUPT_0__OPT_IRQ_net;
	electrical [0:0] tmpSIOVREF__OPT_IRQ_net;

	cy_psoc3_pins_v1_10
		#(.id("6f1bb0bb-6ae8-4078-9566-40702f2d61bb"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OPT_IRQ
		 (.oe(tmpOE__OPT_IRQ_net),
		  .y({1'b0}),
		  .fb({Net_47}),
		  .io({tmpIO_0__OPT_IRQ_net[0:0]}),
		  .siovref(tmpSIOVREF__OPT_IRQ_net),
		  .interrupt({tmpINTERRUPT_0__OPT_IRQ_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OPT_IRQ_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TEMP_IRQ_net;
	wire [0:0] tmpIO_0__TEMP_IRQ_net;
	wire [0:0] tmpINTERRUPT_0__TEMP_IRQ_net;
	electrical [0:0] tmpSIOVREF__TEMP_IRQ_net;

	cy_psoc3_pins_v1_10
		#(.id("f54b4f49-04bd-42c1-a92b-86b6f1b38378"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TEMP_IRQ
		 (.oe(tmpOE__TEMP_IRQ_net),
		  .y({1'b0}),
		  .fb({Net_48}),
		  .io({tmpIO_0__TEMP_IRQ_net[0:0]}),
		  .siovref(tmpSIOVREF__TEMP_IRQ_net),
		  .interrupt({tmpINTERRUPT_0__TEMP_IRQ_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TEMP_IRQ_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CRIT_TEMP_IRQ_net;
	wire [0:0] tmpIO_0__CRIT_TEMP_IRQ_net;
	wire [0:0] tmpINTERRUPT_0__CRIT_TEMP_IRQ_net;
	electrical [0:0] tmpSIOVREF__CRIT_TEMP_IRQ_net;

	cy_psoc3_pins_v1_10
		#(.id("392c6dd7-5fe5-4a97-9402-86e653898af5"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CRIT_TEMP_IRQ
		 (.oe(tmpOE__CRIT_TEMP_IRQ_net),
		  .y({1'b0}),
		  .fb({Net_49}),
		  .io({tmpIO_0__CRIT_TEMP_IRQ_net[0:0]}),
		  .siovref(tmpSIOVREF__CRIT_TEMP_IRQ_net),
		  .interrupt({tmpINTERRUPT_0__CRIT_TEMP_IRQ_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CRIT_TEMP_IRQ_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("f4f09edf-baa4-4b4e-8d59-353b143c51e8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b55035ce-be8c-422a-b56e-55abbb1ba31c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("daf8cc67-d660-4ab4-be5b-e0b253b7d364"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    assign Net_44 = ~(Net_47 & Net_46 & Net_45 & Net_48 & Net_49);
